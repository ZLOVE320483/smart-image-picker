package com.bytedance.image.picker.support.engine
...
interface ImageEngine {
     ...
     */
    fun loadThumbnail(context: Context, resize: Int, placeholer: Drawable, imageView: ImageView, uri: Uri)
     ...
     * @param uri         Uri of the loaded image
     */
    fun loadGifThumbnail(context: Context, resize: Int, placeholer: Drawable, imageView: ImageView, uri: Uri)
